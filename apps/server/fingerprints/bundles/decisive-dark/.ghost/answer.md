...
per the [negative-space frame](negative-space), because a display numeral with a
...
chart](evidence) and suppresses duplicate evidence below. A live-data question renders
...
meaning](meaning) that interprets it, is justified by the [bold evidence](evidence)
beneath it, and may carry the surface's single [accent moment](accent-moment) when the
