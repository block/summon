...
A spec surface proves capability with numbers. Reach for this surface when the
user's first question is "how does this perform, and how does it compare?" — a
performance breakdown, a technical specification, a side-by-side comparison — not
when the job is to stir emotion with a reveal (the [launch](../launch)), to list
many items for transaction (the [catalog](../catalog)), to find a location (the
