...
The warm near-black field is the primary surface and negative space; bright fills
are interruptions, not the default. White text, muted-gray metadata, and hairline
borders stay crisp against it. There are no light-mode shells unless a single
...
it, and the [hazard-pill controls](controls) borrow the same mint/violet accents.
