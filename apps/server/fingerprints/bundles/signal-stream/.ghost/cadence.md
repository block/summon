...
[tear](transmission-grammar) is the splice you feel, the chapter statement is
...
The cadence paces the [tiles and rail](tiles) that carry the content, gives the
[torn-edge transitions and ref codebook](transmission-grammar) their editorial
timing, splits the [type system](type-system) into its skim and dwell voices,
and rations the [hazard accents](canvas) by velocity — saturation rides the skim
