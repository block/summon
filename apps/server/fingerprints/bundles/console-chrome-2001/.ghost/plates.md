...
Depth in Console Chrome comes from hard bevel simulation, halftone command
texture, inset fields, and pictorial hero layers — never blurred elevation. Every
module reads as a hard beveled plate or inset field bolted into the chassis.
...
and every plate earns a [section-label or badge](badges) so it never reads as an
