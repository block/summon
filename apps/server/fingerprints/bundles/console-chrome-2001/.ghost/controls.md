...
These controls live inside [beveled plates and inset fields](plates) and are
framed by the [command and navigation system](command-nav); their amber tool
chips sit alongside the amber stamps of the [badge and section-label
system](badges), which mark status rather than action.
