...
A launch surface announces a product, title, or release with game-box energy.
Reach for this surface when the user's first question is "what is this, and what
do I launch or open?" — a launch page, a product hero, a release announcement —
not when the job is to scan a dense console of modules and status (that is the
[dashboard](../dashboard)), to browse and find many items (that is the
...
than an empty marketing posture. The hero plate and its bevels follow the
[beveled plate and chrome system](../plates); the surrounding command bar and
optional right rail follow the [command and navigation system](../command-nav);
the launch button and any tool chips follow the [control system](../controls).
