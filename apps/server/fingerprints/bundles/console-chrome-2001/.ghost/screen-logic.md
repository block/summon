...
the [hardware dressing system](hardware-dressing), where each carbon scene bar
...
[control system](controls); screen swaps pace the bars and tabs of the [command
and navigation system](command-nav); slot wells press into the [beveled plate
and chrome system](plates); and boot strips and readouts are silkscreen kin of
the [badge and section-label system](badges) — they report the machine's state,
