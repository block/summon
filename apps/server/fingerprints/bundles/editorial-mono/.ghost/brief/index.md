...
A brief commits to a verdict and proves it. Reach for this surface when the user's
first question is "what is the recommendation, and why?" — a decision brief, a
single-recommendation summary, a verdict the reader came to act on — not when the
job is to weigh several options against shared criteria (that is the
[comparison](../comparison)) or to turn a field of metrics into a verdict (that is
the [report](../report)).
...
label and kept shorter and stronger than the evidence. Do not bury the claim under
prose, and do not open with a neutral Overview or Summary title unpaired with a real
verdict.
