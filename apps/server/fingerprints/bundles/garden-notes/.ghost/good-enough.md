...
These two notes are how Garden Notes lowers pressure without hiding useful
context: one names the easiest acceptable move, the other names what does not need
doing now.
