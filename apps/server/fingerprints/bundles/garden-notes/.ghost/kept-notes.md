...
These moves live inside the [note panels](note-panels), obey the [gentle depth
rules](gentle-depth) — the pickup lift is depth with a reason, not a card
pile — and extend the [good-enough choice](good-enough) logic to completion:
