...
const cards = [
  {
    href: "/generate",
    title: "Generate",
    body: "One prompt. Generate a governed Surface Document bundle, stream server-owned diagnostics, render the accepted artifact in the Summon sandbox, and inspect validation.",
    icon: (
      <>
