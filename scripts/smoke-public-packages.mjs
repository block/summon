...
await writeFile(join(projectDir, 'smoke.mjs'), [
  ...
  "import { compileSystemContracts, parseProtocolLine, SectionAccumulator, StreamGraph } from '@anarchitecture/summon/engine';",
  ...
  "for (const forbidden of ['spawnSandbox', 'compileSystemContracts', 'buildCapabilitiesBlock', 'parseProtocolLine', 'StreamGraph']) {",
