...
await writeFile(join(projectDir, 'smoke.mjs'), [
  ...
  "import { compileSystemContracts, deriveSurfacePlanControls, parseProtocolLine, SectionAccumulator, StreamGraph } from '@anarchitecture/summon/engine';",
  ...
  "import { createProtocolLineWriter, runSurfaceGeneration, generateSurfaceStream, resolveSurfaceGenerationPlan, summarizeContractIssues } from '@anarchitecture/summon-server';",
  ...
  "if (typeof createProtocolLineWriter !== 'function' || typeof runSurfaceGeneration !== 'function' || typeof generateSurfaceStream !== 'function' || typeof resolveSurfaceGenerationPlan !== 'function' || typeof summarizeContractIssues !== 'function') throw new Error('server import failed');",
