...
async function buildCore() {
  ...
  const rootEngineRuntimeExports = [
  ...
  const wrappers = {
    'index.js': [
      `export { ${rootHostRuntimeExports.join(', ')} } from './host/index.js';`,
      `export { ${rootEngineRuntimeExports.join(', ')} } from './engine/index.js';`,
      '',
    ].join('\n'),
    'index.d.ts': [
      `export { ${rootHostRuntimeExports.join(', ')} } from './host/index.js';`,
      `export { ${rootEngineRuntimeExports.join(', ')} } from './engine/index.js';`,
      `export type { ${rootHostTypeExports.join(', ')} } from './host/index.js';`,
      `export type { ${rootEngineTypeExports.join(', ')} } from './engine/index.js';`,
      '',
    ].join('\n'),
    'browser.js': "export * from './host/browser.js';\n",
    'browser.d.ts': "export * from './host/browser.js';\n",
    'engine.js': "export * from './engine/index.js';\n",
    'engine.d.ts': "export * from './engine/index.js';\n",
    'host.js': "export * from './host/index.js';\n",
    'host.d.ts': "export * from './host/index.js';\n",
